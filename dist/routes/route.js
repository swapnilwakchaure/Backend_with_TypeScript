...
import { ListModel } from '../models/addToList.js';
import { EventModel } from '../models/eventList.js';
const eventRoute = express.Router();
// --------------- GET REQUEST ADD TO LIST PARTICIPANTS DATA --------------- //
eventRoute.get('/', async (request, response) => {
...
eventRoute.post('/addtolist', async (request, response) => {
...
eventRoute.post('/addevent', async (request, response) => {
...
eventRoute.get('/getevent', async (request, response) => {
    const query = request.query;
    try {
...
eventRoute.delete("/delete/:id", async (request, response) => {
